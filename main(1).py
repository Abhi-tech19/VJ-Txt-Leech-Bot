...
@bot.on_message(filters.command(["defence"]))
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("Now send the Thumb url/nEg » https://files.catbox.moe/uu96ys.jpg \n Or if don't want thumbnail send = no")
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:  
                ...
                cc = f'**[📽️] Vid_ID:** {str(count).zfill(3)}.** {𝗻𝗮𝗺𝗲𝟭}@defencesquad1.mkv \n\n**📚𝐁𝐀𝐓𝐂𝐇 :➠**  **{raw_text0}**\n\n📥 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗕𝗬 : {MR}\n\n━━━━✦𝗗𝗘𝗙𝗘𝗡𝗖𝗘❤️✦━━━━'
                cc1 = f'**[📁] Pdf_ID:** {str(count).zfill(3)}. {𝗻𝗮𝗺𝗲𝟭}@defencesquad1 .mkv \n\n**📚𝐁𝐀𝐓𝐂𝐇 :➠**  **{raw_text0}**\n\n📥 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗕𝗬 : {MR}\n\n━━━━✦𝗗𝗘𝗙𝗘𝗡𝗖𝗘❤𝗕✦━━━━'
                if "drive" in url:
                    try:
